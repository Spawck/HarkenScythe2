 ...
 * (http://bit.ly/18EyAZo)
 *
 * File created @[Mar 5, 2015, 10:44:51 AM]
 */
 ...
 *
 */
public class EnchantmentBloodletting extends Enchantment
{
	public EnchantmentBloodletting(int effectId)
	{
		super(effectId, 1, EnumEnchantmentType.weapon);
		this.setName(Names.Enchantments.BLOODLETTING);
	}
