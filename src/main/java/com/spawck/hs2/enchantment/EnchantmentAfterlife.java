 ...
 * (http://bit.ly/18EyAZo)
 *
 * File created @[Mar 5, 2015, 10:39:57 AM]
 */
 ...
 *
 */
public class EnchantmentAfterlife extends Enchantment
{
	public EnchantmentAfterlife(int effectId)
	{
		super(effectId, 1, EnumEnchantmentType.all);
		this.setName(Names.Enchantments.AFTERLIFE);
	}
	...
	{
		return (super.canApplyTogether(enchantment)) && (enchantment.effectId != HSEnchantments.decapitate.effectId);
	}
}	
