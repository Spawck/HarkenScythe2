 ...
 * (http://bit.ly/18EyAZo)
 *
 * File created @[Mar 5, 2015, 10:43:43 AM]
 */
...
{
	public EnchantmentHemorrhage(int effectId)
	{
		super(effectId, 1, EnumEnchantmentType.bow);
		this.setName(Names.Enchantments.HEMORRHAGE);
	}
	...
	{
		return (super.canApplyTogether(enchantment)) && (enchantment.effectId != HSEnchantments.blight.effectId);
	}
}
