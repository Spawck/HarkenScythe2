 ...
 * (http://bit.ly/18EyAZo)
 *
 * File created @[Mar 5, 2015, 10:42:54 AM]
 */
 ...
 *
 */
public class EnchantmentSoulAttuned extends Enchantment
{
	public EnchantmentSoulAttuned(int effectId)
	{
		super(effectId, 1, EnumEnchantmentType.all);
		this.setName(Names.Enchantments.SOUL_ATTUNED);
	}
	...
	{
		return (super.canApplyTogether(enchantment)) && (enchantment.effectId != HSEnchantments.bloodAttuned.effectId);
	}
}
