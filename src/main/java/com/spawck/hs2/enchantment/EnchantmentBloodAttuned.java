 ...
 * (http://bit.ly/18EyAZo)
 *
 * File created @[Mar 5, 2015, 10:45:26 AM]
 */
 ...
 *
 */
public class EnchantmentBloodAttuned extends Enchantment
{
	public EnchantmentBloodAttuned(int effectId)
	{
		super(effectId, 1, EnumEnchantmentType.all);
		this.setName(Names.Enchantments.BLOOD_ATTUNED);
	}
	...
	{
		return (super.canApplyTogether(enchantment)) && (enchantment.effectId != HSEnchantments.soulAttuned.effectId);
	}
}
