 ...
 * (http://bit.ly/18EyAZo)
 *
 * File created @[Mar 5, 2015, 10:45:47 AM]
 */
 ...
 *
 */
public class EnchantmentBlight extends Enchantment
{
	public EnchantmentBlight(int effectId)
	{
		super(effectId, 1, EnumEnchantmentType.bow);
		this.setName(Names.Enchantments.BLIGHT);
	}
	...
	{
		return (super.canApplyTogether(enchantment)) && (enchantment.effectId != HSEnchantments.hemorrhage.effectId);
	}
}
