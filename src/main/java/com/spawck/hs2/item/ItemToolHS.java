 ...
 * (http://bit.ly/18EyAZo)
 *
 * File created @[Mar 5, 2015, 10:25:53 AM]
 */
 ...
 *
 */
public class ItemToolHS extends ItemTool
{
	public ItemToolHS(float damageVsEntity, Item.ToolMaterial toolMat, Set blocksEffectiveAgainst)
	{
		super(damageVsEntity, toolMat, blocksEffectiveAgainst);
