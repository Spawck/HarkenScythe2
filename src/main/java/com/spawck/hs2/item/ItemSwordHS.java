 ...
 * (http://bit.ly/18EyAZo)
 *
 * File created @[Mar 5, 2015, 10:31:20 AM]
 */
 ...
 *
 */
public class ItemSwordHS extends ItemSword
{
	private float weaponDamage;
	
	public ItemSwordHS(Item.ToolMaterial toolMat)
	{
		super(toolMat);
		this.setCreativeTab(HSTab.HS_TAB);
		this.setMaxStackSize(1);
		this.setMaxDamage(toolMat.getMaxUses());
		this.weaponDamage = (4 + toolMat.getDamageVsEntity());
	}
	...
	{
		return String.format("", Textures.RESOURCE_PREFIX, this.getModifiedUnlocalizedName(super.getUnlocalizedName()));
	}
