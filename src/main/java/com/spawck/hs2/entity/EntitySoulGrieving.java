 ...
 * (http://bit.ly/18EyAZo)
 *
 * File created @[Mar 5, 2015, 10:34:46 AM]
 */
 ...
 *
 */
public class EntitySoulGrieving extends EntitySoul
{
	...
	public EntitySoulGrieving(World world)
	{
		super(world);
		this.aH = "/mod_HarkenScythe/HarkenScytheTex/soul/soulgrieving.png";
	...
	public EntitySoulGrieving(World world, double x, double y, double z, int worth, EntityLiving living)
	{
		this(world);
	...
	{
		return this.aH = "/mods/mod_HarkenScythe/textures/models/soul/soulgrieving.png";
	}
